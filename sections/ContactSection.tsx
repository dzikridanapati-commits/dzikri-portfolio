          ...
          >
            <div>
              ...
              <p className="text-gray-400 font-medium max-w-md text-sm md:text-base leading-relaxed mb-12">
                Have an idea or project in mind? Let&apos;s build something great together. Reach out and let&apos;s talk.
              </p>
            </div>
            ...
            <form className="relative z-10 flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label htmlFor="name" className="text-[10px] font-bold uppercase tracking-widest text-gray-500 ml-2">Your Name</label>
                  <input
                    type="text"
                    id="name"
                ...
                <div className="space-y-2">
                  <label htmlFor="email" className="text-[10px] font-bold uppercase tracking-widest text-gray-500 ml-2">Email Address</label>
                  <input
                    type="email"
                    id="email"
