            ...
            <div className="border-t-2 border-foreground/10 px-4 py-3 flex flex-col gap-2 shrink-0">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 text-[16px] leading-tight font-medium bg-gray-100 rounded-xl px-4 py-2.5 outline-none focus:ring-2 focus:ring-foreground/20 disabled:opacity-50 placeholder:text-gray-400"
                />
                <button
                  type="button"
